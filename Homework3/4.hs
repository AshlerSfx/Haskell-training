...
helper (x:xs) br1 br2 br3                |x == '(' = helper xs (br1 + 1) br2 br3
                                         |x == ')' = if br1 == 0 then False else helper xs (br1 - 1) br2 br3
                                         |x == '[' = helper xs br1 (br2 + 1) br3
                                         |x == ']' = if br2 == 0 then False else helper xs br1 (br2 - 1) br3
                                         |x == '{' = helper xs br1 br2 (br3 + 1)
                                         |x == '}' = if br3 == 0 then False else helper xs br1 br2 (br3 - 1)
