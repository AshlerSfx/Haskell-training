...
findPhone (line:other) reqName = if name line == reqName then 
                                            number line 
                                        else 
                                            findPhone other reqName


findName :: [Person] -> String -> String
findName [] _ = "Nothing found"
findName (line:other) reqPhone = if number line == reqPhone then
                                            name line
                                         else 
                                            findName other reqPhone
